...
class MyAwesomeModel(nn.Module):
    def __init__(self, n_classes):
        ...
        self.layer2 = nn.Sequential(
            nn.Conv2d(
                in_channels=n_out_features1, out_channels=n_out_features2, kernel_size=KERNEL_SIZE, stride=1, padding=1
            ),
        ...
        self.layer3 = nn.Sequential(
            nn.Conv2d(
                in_channels=n_out_features2, out_channels=n_out_features3, kernel_size=KERNEL_SIZE, stride=1, padding=1
            ),
